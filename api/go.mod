...
require (
	...
	github.com/lightstep/otel-launcher-go v1.10.0 // indirect
	github.com/lightstep/otel-launcher-go/lightstep/sdk/metric v1.10.0 // indirect
	github.com/lightstep/otel-launcher-go/pipelines v1.10.0 // indirect
