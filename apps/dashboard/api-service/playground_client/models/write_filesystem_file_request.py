...
class WriteFilesystemFileRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WriteFilesystemFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WriteFilesystemFileRequest:
