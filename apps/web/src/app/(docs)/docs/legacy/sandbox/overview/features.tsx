...
export const features = [
  ...
  <span>
    <Link href="/docs/getting-started/installation">Python & Node.js SDK</Link>{' '}
    for controling the sandbox&apos;s{' '}
    <Link href="/docs/sandbox/api/filesystem">filesystem</Link>,{' '}
    <Link href="/docs/sandbox/api/process">processes</Link>, and more.
  </span>,
  'Support for up to 24h long-running sandbox sessions',
  <span>
    Ability to <Link href="/docs/sandbox/api/upload">upload files</Link> to the
    sandbox and <Link href="/docs/sandbox/api/download">download files </Link>
    from the sandbox,
  </span>,
