...
- [Sandbox operations & requests to sandboxes](#sandbox-operations--requests-to-sandboxes)
...
For example, if you on the Pro tier (without any concurrency addons) you can create up to 100 sandboxes running concurrently.
...
After the number of running sandboxes drops below 100 or you purchase the concurrency addon, you will be able to create new sandboxes again.