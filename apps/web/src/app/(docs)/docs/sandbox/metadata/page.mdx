...
<Note>
If you're using the [beta version of the SDK](/docs/sandbox/persistence#1-installing-the-beta-version-of-the-sdks), the `Sandbox.list()` method was updated. See [List Sandboxes](/docs/sandbox/list#changes-in-the-beta-sdks) for more information.
</Note>
