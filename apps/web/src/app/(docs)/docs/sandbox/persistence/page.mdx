...
1. [Reach out to us](/docs/support) with your use caseto get access to the beta.
...
=======
>>>>>>> e81a6dc06d59e775bdd9579d9c3226cee35924cd
```
...
<<<<<<< HEAD
pip install e2b-code-interpreter==1.0.4b0
#
# or use Core: https://github.com/e2b-dev/e2b
# pip install e2b==1.1.0.b17
#
# or use Desktop: https://github.com/e2b-dev/desktop
# pip install e2b-desktop==1.1.0.b0
=======
