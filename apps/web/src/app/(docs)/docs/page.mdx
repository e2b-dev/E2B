...
## What is E2B?
E2B is an [open-source](https://github.com/e2b-dev) infrastructure that allows you to [run AI-generated code](/docs/code-interpreting/analyze-data-with-ai) or [launch secure cloud desktops](/docs/computer-use) in secure isolated sandboxes in the cloud.
