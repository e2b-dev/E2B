...
| ------ | ------ | ------ | ------ | ------ |
| `commands` | `readonly` | `Commands` | Module for running commands in the sandbox | sandbox/index.ts:74 |
| `files` | `readonly` | `Filesystem` | Module for interacting with the sandbox filesystem | sandbox/index.ts:70 |
| `pty` | `readonly` | `Pty` | Module for interacting with the sandbox pseudo-terminals | sandbox/index.ts:78 |
| `sandboxId` | `readonly` | `string` | Unique identifier of the sandbox. | sandbox/index.ts:83 |
