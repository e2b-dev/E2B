...
1. You build a custom sandbox by creating the [Sandbox Template](/sandbox/templates/template-file) which essentially is a Dockerfile describing the environment of your sandbox.
