...
Call the `keep_alive`/`keepAlive` method on the sandbox instance to keep it alive. You can specify a red duration, as a multiple of a default time unit, which is
- 1ms in JS
- 1s in Python.
