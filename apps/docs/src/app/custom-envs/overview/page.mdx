...
We're using Docker to build your sandboxes, create a Dockerfile with all the dependencies you need.

There are few limitations:
- It must be based on Ubuntu
...
If you want to keep your sandbox Dockerimage somewhere else, you can run  the `--dockerfile` flag.
