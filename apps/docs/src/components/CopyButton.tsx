  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-brand-400/20 ring-brand-400/20 ring-1 ring-inset'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'text-brand-400 pointer-events-none absolute inset-0 flex items-center justify-center transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
