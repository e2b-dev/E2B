...
export const Header = forwardRef(function Header({ className }, ref) {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        className,
        'fixed inset-x-0 top-0 z-50 flex h-14 items-center justify-between gap-12 px-4 transition sm:px-6 lg:left-[var(--sidebar-nav-width)] lg:z-30 lg:px-8',
        !isInsideMobileNavigation &&
          'backdrop-blur-sm dark:backdrop-blur lg:left-[var(--sidebar-nav-width)]',
        isInsideMobileNavigation
