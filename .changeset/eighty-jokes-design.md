...
- Shell-quote paths and arguments in `remove`, `rename`, `make_dir`, `make_symlink`, `git_clone` (URL/branch/path), and the devcontainer helpers so values with spaces or shell metacharacters work correctly.
