...
import { asDim, asPrimary } from 'src/utils/format'
...
Visit ${asPrimary('E2B docs')} (${asDim('https://e2b.dev/docs')}) to learn how to create sandbox templates and start sandboxes.
`)
