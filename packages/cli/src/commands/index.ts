...
export const program = new commander.Command()
  .description(`Create sandbox templates from Dockerfiles by running ${asPrimary('e2b template build')} then use our SDKs to create sandboxes from these templates.
