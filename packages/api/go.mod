...
require (
	...
	github.com/open-telemetry/otel-arrow v0.3.0 // indirect
	github.com/open-telemetry/otel-arrow/collector v0.3.0 // indirect
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/host v0.43.0 // indirect
