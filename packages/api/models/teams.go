...
func (teamL) LoadEnvs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (teamL) LoadTeamAPIKeys(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (teamL) LoadUsersTeams(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
...
func (o *Team) AddEnvs(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Env) error {
	var err error
...
// Sets related.R.Team appropriately.
func (o *Team) AddTeamAPIKeys(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamAPIKey) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.TeamID = o.ID
...
// Sets related.R.Team appropriately.
func (o *Team) AddUsersTeams(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersTeam) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.TeamID = o.ID
