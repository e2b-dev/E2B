...
type (
	...
	UsersTeamHook func(boil.Executor, *UsersTeam) error
...
func (o *UsersTeam) doAfterSelectHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doBeforeInsertHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doAfterInsertHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doBeforeUpdateHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doAfterUpdateHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doBeforeDeleteHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doAfterDeleteHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doBeforeUpsertHooks(exec boil.Executor) (err error) {
...
func (o *UsersTeam) doAfterUpsertHooks(exec boil.Executor) (err error) {
...
func (q usersTeamQuery) One(exec boil.Executor) (*UsersTeam, error) {
	o := &UsersTeam{}
...
func (q usersTeamQuery) All(exec boil.Executor) (UsersTeamSlice, error) {
	var o []*UsersTeam
...
func (q usersTeamQuery) Count(exec boil.Executor) (int64, error) {
	var count int64
...
func (q usersTeamQuery) Exists(exec boil.Executor) (bool, error) {
	var count int64
...
func (usersTeamL) LoadTeam(e boil.Executor, singular bool, maybeUsersTeam interface{}, mods queries.Applicator) error {
	var slice []*UsersTeam
...
func (o *UsersTeam) SetTeam(exec boil.Executor, insert bool, related *Team) error {
	var err error
	if insert {
...
func FindUsersTeam(exec boil.Executor, userID string, teamID string, selectCols ...string) (*UsersTeam, error) {
	...
	err := q.Bind(nil, exec, usersTeamObj)
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			return nil, sql.ErrNoRows
		}
	...
	if err = usersTeamObj.doAfterSelectHooks(exec); err != nil {
...
func (o *UsersTeam) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
...
func (o *UsersTeam) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	var err error
...
func (q usersTeamQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
...
func (o UsersTeamSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
...
func (o *UsersTeam) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
...
func (o *UsersTeam) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
...
func (q usersTeamQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
...
func (o UsersTeamSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
...
func (o *UsersTeam) Reload(exec boil.Executor) error {
	ret, err := FindUsersTeam(exec, o.UserID, o.TeamID)
	if err != nil {
		return err
	}
...
func (o *UsersTeamSlice) ReloadAll(exec boil.Executor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
...
func UsersTeamExists(exec boil.Executor, userID string, teamID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users_teams\" where \"user_id\"=$1 AND \"team_id\"=$2 limit 1)"

	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, sql)
		fmt.Fprintln(boil.DebugWriter, userID, teamID)
	}
	row := exec.QueryRow(sql, userID, teamID)
...
func (o *UsersTeam) Exists(exec boil.Executor) (bool, error) {
	return UsersTeamExists(exec, o.UserID, o.TeamID)
}
