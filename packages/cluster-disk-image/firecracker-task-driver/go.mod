module github.com/devbookhq/devbook-api/packages/cluster-disk-image/firecracker-task-driver
...
require (
	...
	github.com/lightstep/otel-launcher-go/pipelines v1.10.1 // indirect
