...
const (
	pluginName        = "fc-instance-task-driver"
...
func (d *Driver) ExecTask(taskID string, cmd []string, timeout time.Duration) (*drivers.ExecTaskResult, error) {
	return nil, fmt.Errorf("fc-instance-task-driver does not support exec")
}

func (d *Driver) SignalTask(taskID string, signal string) error {
	return fmt.Errorf("fc-instance-task-driver does not support signal")
}
