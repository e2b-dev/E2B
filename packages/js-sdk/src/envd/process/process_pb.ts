...
export const file_process_process: GenFile =
  /*@__PURE__*/
  fileDesc(
    ''
  )
...
export type ProcessEvent_StartEvent =
  Message<'process.ProcessEvent.StartEvent'> & {
    ...
    /**
     * Position in each output stream at which the output following this
     * event begins: zero for a fresh start, the current position for a
     * live-only connect, the requested position for a resumed one. Absent
     * when the server does not retain output for resuming.
     *
     * @generated from field: optional process.OutputOffsets offsets = 2;
     */
...
export type ProcessEvent_DataEvent =
  Message<'process.ProcessEvent.DataEvent'> & {
    ...
    /**
     * Position of the first byte of this chunk within its output stream,
     * counted from the start of the process. Absent when the server does
     * not retain output for resuming.
     *
...
export type ConnectRequest = Message<'process.ConnectRequest'> & {
  ...
  /**
   * When set, output retained since these offsets is replayed before live
   * output continues from it. Fails with OUT_OF_RANGE when an offset is older
   * than what is still retained, and with INVALID_ARGUMENT when it is beyond
   * what the process has produced.
   *
   * @generated from field: optional process.OutputOffsets resume_from = 2;
   */
  resumeFrom?: OutputOffsets
}
...
/**
 * Byte positions in each output stream of a process. A stream the process
 * does not use (pty for a piped process, stdout/stderr for a pty one) stays 0.
 *
 * @generated from message process.OutputOffsets
 */
export type OutputOffsets = Message<'process.OutputOffsets'> & {
  /**
   * @generated from field: uint64 stdout = 1;
   */
  stdout: bigint

  /**
   * @generated from field: uint64 stderr = 2;
   */
  stderr: bigint

  /**
   * @generated from field: uint64 pty = 3;
   */
  pty: bigint
}

/**
 * Describes the message process.OutputOffsets.
 * Use `create(OutputOffsetsSchema)` to create a new message.
 */
export const OutputOffsetsSchema: GenMessage<OutputOffsets> =
  /*@__PURE__*/
...
export const ProcessSelectorSchema: GenMessage<ProcessSelector> =
  /*@__PURE__*/
  messageDesc(file_process_process, 22)
