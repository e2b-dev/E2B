...
// @generated from file envd/process/process.proto (package envd.process, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum envd.process.Signal
 */
export enum Signal {
  /**
...
proto3.util.setEnumType(Signal, "envd.process.Signal", [
...
/**
 * @generated from message envd.process.PTY
 */
export class PTY extends Message<PTY> {
  /**
   * @generated from field: envd.process.PTY.Size size = 1;
   */
  size?: PTY_Size;
  ...
  static readonly typeName = "envd.process.PTY";
...
/**
 * @generated from message envd.process.PTY.Size
 */
export class PTY_Size extends Message<PTY_Size> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.PTY.Size";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.ProcessConfig
 */
export class ProcessConfig extends Message<ProcessConfig> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ProcessConfig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.ListRequest
 */
export class ListRequest extends Message<ListRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ListRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message envd.process.StartRequest
 */
export class StartRequest extends Message<StartRequest> {
  /**
   * @generated from field: envd.process.ProcessConfig process = 1;
   */
  process?: ProcessConfig;

  /**
   * @generated from field: optional envd.process.PTY pty = 2;
   */
  pty?: PTY;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.StartRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.UpdateRequest
 */
export class UpdateRequest extends Message<UpdateRequest> {
  /**
   * @generated from field: envd.process.ProcessSelector process = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.UpdateRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.UpdateResponse
 */
export class UpdateResponse extends Message<UpdateResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.UpdateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message envd.process.ProcessEvent
 */
export class ProcessEvent extends Message<ProcessEvent> {
  /**
   * @generated from oneof envd.process.ProcessEvent.event
   */
  event: {
    /**
     * @generated from field: envd.process.ProcessEvent.StartEvent start = 1;
     */
    value: ProcessEvent_StartEvent;
    case: "start";
  } | {
    /**
     * @generated from field: envd.process.ProcessEvent.DataEvent data = 2;
     */
    value: ProcessEvent_DataEvent;
    case: "data";
  } | {
    /**
     * @generated from field: envd.process.ProcessEvent.EndEvent end = 3;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ProcessEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.ProcessEvent.StartEvent
 */
export class ProcessEvent_StartEvent extends Message<ProcessEvent_StartEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ProcessEvent.StartEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.ProcessEvent.DataEvent
 */
export class ProcessEvent_DataEvent extends Message<ProcessEvent_DataEvent> {
  /**
   * @generated from oneof envd.process.ProcessEvent.DataEvent.output
   */
  output: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ProcessEvent.DataEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.ProcessEvent.EndEvent
 */
export class ProcessEvent_EndEvent extends Message<ProcessEvent_EndEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ProcessEvent.EndEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.StartResponse
 */
export class StartResponse extends Message<StartResponse> {
  /**
   * @generated from field: envd.process.ProcessEvent event = 1;
   */
  event?: ProcessEvent;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.StartResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.ConnectResponse
 */
export class ConnectResponse extends Message<ConnectResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ConnectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "event", kind: "message", T: ProcessEvent },
  ]);
...
/**
 * @generated from message envd.process.SendInputRequest
 */
export class SendInputRequest extends Message<SendInputRequest> {
  ...
  /**
   * @generated from field: envd.process.ProcessInput input = 2;
   */
  input?: ProcessInput;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.SendInputRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "process", kind: "message", T: ProcessSelector },
...
/**
 * @generated from message envd.process.SendInputResponse
 */
export class SendInputResponse extends Message<SendInputResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.SendInputResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message envd.process.ProcessInput
 */
export class ProcessInput extends Message<ProcessInput> {
  /**
   * @generated from oneof envd.process.ProcessInput.input
   */
  input: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ProcessInput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.StreamInputRequest
 */
export class StreamInputRequest extends Message<StreamInputRequest> {
  /**
   * @generated from oneof envd.process.StreamInputRequest.event
   */
  event: {
    /**
     * @generated from field: envd.process.StreamInputRequest.StartEvent start = 1;
     */
    value: StreamInputRequest_StartEvent;
    case: "start";
  } | {
    /**
     * @generated from field: envd.process.StreamInputRequest.DataEvent data = 2;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.StreamInputRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message envd.process.StreamInputRequest.StartEvent
 */
export class StreamInputRequest_StartEvent extends Message<StreamInputRequest_StartEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.StreamInputRequest.StartEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "process", kind: "message", T: ProcessSelector },
  ]);
...
/**
 * @generated from message envd.process.StreamInputRequest.DataEvent
 */
export class StreamInputRequest_DataEvent extends Message<StreamInputRequest_DataEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.StreamInputRequest.DataEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "input", kind: "message", T: ProcessInput },
  ]);
...
/**
 * @generated from message envd.process.StreamInputResponse
 */
export class StreamInputResponse extends Message<StreamInputResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.StreamInputResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message envd.process.SendSignalRequest
 */
export class SendSignalRequest extends Message<SendSignalRequest> {
  ...
  /**
   * @generated from field: envd.process.Signal signal = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.SendSignalRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "process", kind: "message", T: ProcessSelector },
...
/**
 * @generated from message envd.process.SendSignalResponse
 */
export class SendSignalResponse extends Message<SendSignalResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.SendSignalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message envd.process.ConnectRequest
 */
export class ConnectRequest extends Message<ConnectRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "envd.process.ConnectRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "process", kind: "message", T: ProcessSelector },
  ]);
...
/**
 * @generated from message envd.process.ProcessSelector
 */
export class ProcessSelector extends Message<ProcessSelector> {
  /**
   * @generated from oneof envd.process.ProcessSelector.selector
   */
  selector: {
    /**
     * @generated from field: uint32 pid = 1;
