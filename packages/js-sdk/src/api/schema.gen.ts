...
export interface paths {
    ...
    "/sandboxes/{sandboxID}/cpus": {
        ...
        get?: never;
        put?: never;
        /** @description Set the number of online vcpus */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": {
                        /**
                         * Format: uint32
                         * @description Number of vcpus to make online
                         */
                        onlineCpus: number;
                    };
                };
            ...
            responses: {
                /** @description Successfully updated the number of online vcpus */
                204: {
                    headers: {
                        [name: string]: unknown;
                    };
