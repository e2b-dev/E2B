...
describe('file signing', () => {
  ...
  sandboxTest('test access file with expired signing', async ({ sandbox }) => {
  ...
  sandboxTest('test access file with valid signing', async ({ sandbox }) => {
    await sandbox.files.write('hello.txt', 'hello world')
  ...
  sandboxTest('test upload file with valid signing', async ({ sandbox }) => {
  ...
  sandboxTest('test upload file with invalid signing', async ({ sandbox }) => {
    const fileUrlWithSigning = await sandbox.uploadUrl('hello.txt', {
  ...
  sandboxTest('test command run with secured sbx', async ({ sandbox }) => {
