...
class FilesystemManager(BaseModel):
    _service_name: ClassVar[str] = "filesystem"
    ...
    async def read_bytes(self, path: str) -> bytearray:
        ...
        """
        result: str = await self.session_connection.call(self._service_name, "readBase64", [path])
    ...
    async def write_bytes(self, path: str, content: bytearray) -> None:
        ...
        """
        # TODO: Encode the byte array as a base64 string
        base64_content = base64.b64encode(content).decode('utf-8')
        await self.session_connection.call(self._service_name, 'writeBase64', [path, base64_content])
    ...
    async def read(self, path: str) -> str:
        ...
        """
        result: str = await self.session_connection.call(self._service_name, "read", [path])
        return result
    ...
    async def write(self, path: str, content: str) -> None:
        ...
        """
        await self.session_connection.call(self._service_name, 'write', [path, content])
    ...
    async def remove(self, path: str) -> None:
        ...
        """
        await self.session_connection.call(self._service_name, "remove", [path])
    ...
    async def list(self, path: str) -> List[FileInfo]:
        ...
        """
        result: List[Any] = await self.session_connection.call(self._service_name, "list", [path])
    ...
    async def make_dir(self, path: str) -> None:
        ...
        """
        await self.session_connection.call(self._service_name, "makeDir", [path])
    ...
    async def watch_dir(self, path: str) -> FilesystemWatcher:
        ...
        return FilesystemWatcher(session_connection=self.session_connection, path=str(npath))
