...
def test_request_build_preserves_zero_and_omission(monkeypatch):
    bodies = []
    ...
    template_sync_build_api.request_build(client, "team-default", None, 2, 1024, None)
    template_sync_build_api.request_build(client, "no-growth", None, 2, 1024, 0)
