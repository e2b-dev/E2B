...
class SandboxLogs(BaseModel):
    ...
    logs: conlist(StrictStr) = Field(..., description="Logs of the sandbox")
    logs_offset: StrictInt = Field(
        ..., alias="logsOffset", description="Index of the last log"
    )
    additional_properties: Dict[str, Any] = {}
    __properties = ["logs", "logsOffset"]
    ...
    def from_dict(cls, obj: dict) -> SandboxLogs:
        ...
        _obj = SandboxLogs.parse_obj(
            {"logs": obj.get("logs"), "logs_offset": obj.get("logsOffset")}
        )
