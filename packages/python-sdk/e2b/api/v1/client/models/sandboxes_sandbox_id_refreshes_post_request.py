...
class SandboxesSandboxIDRefreshesPostRequest(BaseModel):
    ...
    duration: Optional[conint(strict=True, le=3600, ge=0)] = Field(
        None,
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SandboxesSandboxIDRefreshesPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SandboxesSandboxIDRefreshesPostRequest:
        """Create an instance of SandboxesSandboxIDRefreshesPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SandboxesSandboxIDRefreshesPostRequest.parse_obj(obj)

        _obj = SandboxesSandboxIDRefreshesPostRequest.parse_obj(
