...
class AsyncVolume:
    ...
    async def make_dir(
        ...
        **opts: Unpack[ApiParams],
        ...
        res = await post_volumes_volume_id_dir.asyncio_detailed(
            volume_id=self._volume_id,
            path=path,
    ...
    async def write_file(
        ...
        **opts: Unpack[ApiParams],
        ...
        res = await put_volumes_volume_id_file.asyncio_detailed(
            volume_id=self._volume_id,
    ...
    async def remove(
        ...
        **opts: Unpack[ApiParams],
        ...
        if is_directory:
            res = await delete_volumes_volume_id_dir.asyncio_detailed(
                volume_id=self._volume_id,
                path=path,
            ...
            res = await delete_volumes_volume_id_file.asyncio_detailed(
                volume_id=self._volume_id,
                path=path,
                client=api_client,
            )
