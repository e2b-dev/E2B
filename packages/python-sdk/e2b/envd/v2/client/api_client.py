...
import e2b.envd.v2.client.models
from e2b.envd.v2.client import rest
from e2b.envd.v2.client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(e2b.envd.v2.client.models, klass)
