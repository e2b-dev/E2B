...
from typing import Any, Generator, Coroutine, AsyncGenerator
...
class FilesystemClient:
    def __init__(self, base_url: str, *, pool: ConnectionPool, async_pool: AsyncConnectionPool, compressor=None, json=False, **opts):
