...
class ProcessEvent(Message[_ProcessEventFields]):
    ...
    _StartEventFields: TypeAlias = Literal["pid", "offsets"]
    ...
    class StartEvent(Message[_StartEventFields]):
        ...
        Attributes:
            ...
            offsets:
                ...
                ```proto
                optional process.OutputOffsets offsets = 2;
                ```
        """

        __slots__ = ("pid", "offsets")
        ...
        if TYPE_CHECKING:
            ...
            def __init__(
                ...
                *,
                pid: int = 0,
                offsets: OutputOffsets | None = None,
            ) -> None:
                pass

            pid: int
            offsets: OutputOffsets | None

    _DataEventFields: TypeAlias = Literal["stdout", "stderr", "pty", "offset"]
...
_ConnectRequestFields: TypeAlias = Literal["process", "resume_from"]
...
class ConnectRequest(Message[_ConnectRequestFields]):
    ...
    Attributes:
        ...
        resume_from:
            ...
            ```proto
            optional process.OutputOffsets resume_from = 2;
            ```
    """

    __slots__ = ("process", "resume_from")
    ...
    if TYPE_CHECKING:
        ...
        def __init__(
            ...
            *,
            process: ProcessSelector | None = None,
            resume_from: OutputOffsets | None = None,
        ) -> None:
            pass

        process: ProcessSelector | None
        resume_from: OutputOffsets | None

_OutputOffsetsFields: TypeAlias = Literal["stdout", "stderr", "pty"]

class OutputOffsets(Message[_OutputOffsetsFields]):
    """
