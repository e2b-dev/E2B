...
class DefaultApi(object):
    ...
    def create_mock_body_data_with_http_info(self, create_mock_body_data_request : CreateMockBodyDataRequest, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MockDataResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def update_deployment(self, project_id : StrictStr, session_id : Annotated[StrictStr, Field(..., description="active session to use for deployment")], update_deployment_request : UpdateDeploymentRequest, **kwargs) -> None:  # noqa: E501
        """update_deployment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_deployment(project_id, session_id, update_deployment_request, async_req=True)
        >>> result = thread.get()
        ...
        :param session_id: active session to use for deployment (required)
        :type session_id: str
        :param update_deployment_request: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_deployment_with_http_info(project_id, session_id, update_deployment_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_deployment_with_http_info(self, project_id : StrictStr, session_id : Annotated[StrictStr, Field(..., description="active session to use for deployment")], update_deployment_request : UpdateDeploymentRequest, **kwargs):  # noqa: E501
        """update_deployment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_deployment_with_http_info(project_id, session_id, update_deployment_request, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['update_deployment_request']:
            _body_params = _params['update_deployment_request']
