...
class RunProcessResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunProcessResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunProcessResponse:
        """Create an instance of RunProcessResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RunProcessResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in RunProcessResponse) in the input: " + obj)
