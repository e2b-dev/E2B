...
class MockDataResponse(BaseModel):
    ...
    """
    mock_data: MockDataResponseMockData = Field(..., alias="mockData")
    __properties = ["mockData"]
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of mock_data
        if self.mock_data:
            _dict['mockData'] = self.mock_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: dict) -> MockDataResponse:
        ...
        _obj = MockDataResponse.parse_obj({
            "mock_data": MockDataResponseMockData.from_dict(obj.get("mockData")) if obj.get("mockData") is not None else None
        })
        return _obj
