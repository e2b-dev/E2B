...
class CreateMockDataRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMockDataRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMockDataRequest:
        """Create an instance of CreateMockDataRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateMockDataRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateMockDataRequest) in the input: " + obj)

        _obj = CreateMockDataRequest.parse_obj({
